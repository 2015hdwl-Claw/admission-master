...
const QUIZ_RESULTS: Record<string, QuizResult> = {
  type_a: {
    ...
    emoji: '🧩',
    description:
      '你喜歡玩電腦、手機，對各種軟體都很上手。遇到問題時，你會想找邏輯性的解決方法，不憑感覺。程式設計、網路、電子產品這些科技相關的領域，會讓你覺得很有趣也很有成就感。',
  ...
  type_b: {
    ...
    emoji: '🔧',
    description:
      '你喜歡動手做東西，不管是木工、金工還是機械，你都覺得很有趣。你不怕花時間把東西做得精緻完美，喜歡看到實際做出來的作品。機械、化工、土木這些領域，能讓你發揮這樣的特長。',
  ...
  type_c: {
    ...
    emoji: '⚓',
    description:
      '你很喜歡跟人互動，也很照顧別人的感受。幫助別人讓你覺得很有意義，你的溝通能力也不錯，容易跟人打成一片。餐旅、護理、這些需要跟人接觸的工作，會很適合你。',
  ...
  type_d: {
    ...
    emoji: '🎨',
    description:
      '你對美感很敏銳，喜歡美的事物，也有很多新點子。你不喜歡被規矩束縛，想用自己的方式表達。設計、創意、行銷這些領域，能讓你自由發揮創意，做出讓人驚艷的作品。',
