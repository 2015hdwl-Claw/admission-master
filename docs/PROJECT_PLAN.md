...
3 個功能，目標：學生開始記錄校園活動
  4. 校曆同步（手動輸入學校行事曆，系統自動連結學習歷程代碼）
  5. 素材記錄（基本版，按代碼分類，輕量記錄介面）
  6. 科系探索（58 學類基本資料）

#### Phase 3：成就回顧 + 家長視角（Week 6-8）
3 個功能，目標：學生看到自己的累積、家長開始看到進度
  7. 成就時光軸（不是 streak 壓力，是回顧「你這個月做了什麼」）
  8. 家長註冊 + 免費週報（摘要版）
  9. 升學管道資料頁（15+ 管道）
...
3 個功能，目標：首筆家長付費
  10. 付費牆 + 訂閱系統
  11. 家長完整成長報告（詳細版 + AI 成長亮點摘要）
  12. AI 學習歷程審查

#### Phase 5：擴展（Week 13-20）
每 2 週加 1 個功能，基於用戶回饋決定優先序：
  13. 面試模擬
  14. 科系策略報告
  15. MBTI 式科系測驗（病毒傳播第二引擎）
  16. 高職版（統測分析）
  17. 匿名結果牆
  18. 素材管理進階（AI 建議補充、空缺分析）
